...
import ee.carlrobert.llm.client.together.TogetherClient;
...
public class TogetherClientTest extends BaseTest {
  ...
  void shouldStreamChatCompletion() {
    ...
    expectTogether((StreamHttpExchange) request -> {
    ...
    new TogetherClient("TEST_API_KEY")
